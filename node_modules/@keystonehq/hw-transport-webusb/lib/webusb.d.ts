...
export declare class TransportWebUSB implements TransportHID {
    #private;
    private device;
    private endpoint;
    ...
    static getKeystoneDevices(): Promise<USBDevice[]>;
    static getFirstKeystoneDevice(): Promise<USBDevice>;
...
export declare function createKeystoneTransport(timeout?: number): Promise<TransportWebUSB>;
